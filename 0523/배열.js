...
console.log(index);
console.log(colors.indexOf("black")); //존재하지 않으면 -1 리턴

//includes  //존재 유무 t/f로 출력
...
const [마이클, 존, 엘렌, 사라] = persons;  //순서가 중요
console.log(마이클);
const {name, age, gender, job} = 마이클; //순서가 중요하지X, key 이름이 중요
